...
export default {
  ...
  apply(ctx) {
    ...
    // Desktop renderer uses this packaged, fixed custom origin instead of the
    // Web host's http(s) origin. It is not a wildcard: arbitrary origins stay
    // rejected for OAuth and unbind actions.
